...
class _$CalendarEventImpl implements _CalendarEvent {
  ...
  @override
  String toString() {
    return 'CalendarEvent(id: $id, title: $title, startDate: $startDate, isAllDay: $isAllDay, attendeeEmails: $attendeeEmails, calendarId: $calendarId)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, title, startDate, isAllDay,
      const DeepCollectionEquality().hash(_attendeeEmails), calendarId);
...
abstract class _CalendarEvent implements CalendarEvent {
  const factory _CalendarEvent(
      ...
      required final List<String> attendeeEmails,
      required final String calendarId}) = _$CalendarEventImpl;
