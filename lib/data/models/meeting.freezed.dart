...
class _$MeetingImpl extends _Meeting {
  ...
  @override
  String toString() {
    return 'Meeting(id: $id, userId: $userId, name: $name, date: $date, weight: $weight, participantIds: $participantIds, activityIds: $activityIds, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
