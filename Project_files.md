...
- lib/presentation/import/meeting_inbox_screen.dart - MeetingInboxScreen (Pending Meetings) — list of ImportCandidate cards with progress indicator; empty state shows waiting_room.png illustration with Import from Calendar CTA; waiting_room.png also rendered as last decorative item in non-empty list; auto-navigates to ImportSuccessScreen when inbox empty after processing (US-068, US-077)
...
- lib/presentation/persons/person_detail_screen.dart - Person detail screen — shows name, meeting count, edit via dialog, delete with confirmation, _NicknamesSection with InputChip list and add field (US-025, US-061)
...
- lib/presentation/screens/main_screen.dart - Root screen after login — BottomNavigationBar with 4 tabs + FAB + Drawer (drawer_icon.png illustration in green header, Import from Calendar, Pending Meetings badge, Settings, Logout); DeleteAccountProvider added to SettingsScreen MultiProvider call-site; drawer handler catches CalendarAuthException (auth expired) vs generic exceptions (network) separately; owns HomeProvider, PersonsListProvider, ActivitiesListProvider, StatisticsProvider, CalendarSettingsProvider, MeetingInboxProvider lifecycle; tap counter + Timer logic for easter egg (US-026, US-027, US-031, US-064, US-065, US-066, US-068, US-072, US-076, US-077, US-078)
