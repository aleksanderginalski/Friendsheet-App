...
- lib/presentation/screens/main_screen.dart - Root screen after login — BottomNavigationBar with 4 tabs + FAB + Drawer (Import from Calendar, Pending Meetings badge, Settings, Logout); DeleteAccountProvider added to SettingsScreen MultiProvider call-site; drawer handler catches CalendarAuthException (auth expired) vs generic exceptions (network) separately; owns HomeProvider, PersonsListProvider, ActivitiesListProvider, StatisticsProvider, CalendarSettingsProvider, MeetingInboxProvider lifecycle; tap counter + Timer logic for easter egg (US-026, US-027, US-031, US-064, US-065, US-066, US-068, US-072, US-076, US-078)
