$descriptions = @{
    ...
    "test/presentation/providers/meetings_list_provider_test.dart"     = "MeetingsListProvider tests"
    ...
    "test/presentation/screens/main_screen_test.dart"                  = "MainScreen tests"
