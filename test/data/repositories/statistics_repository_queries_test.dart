// test/data/repositories/statistics_repository_queries_test.dart
//
// Tests for StatisticsRepository query methods:
// getAvailableYears, getMeetingsForYear, getActivityWeightBreakdown,
  ...
  group('StatisticsRepository', () {
    ...
    group('getMeetingsForYear()', () {
      test('returns only meetings within the given year', () async {
        ...
        // Year with no data returns empty.
        final noData = await repository.getMeetingsForYear('user-1', 2020);
